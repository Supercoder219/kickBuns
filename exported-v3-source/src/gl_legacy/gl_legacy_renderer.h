...
typedef struct {
    ...
    // Mac OS 9-era OpenGL implementations frequently have no framebuffer
    // objects. In that case, render application_surface directly to the
    // window framebuffer. User-created surfaces remain unavailable.
